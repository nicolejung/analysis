class AdditionalsController < ApplicationController
  ...
  private
    ...
    def additional_params
      params.require(:additional).permit(:raman, :hrms, :uv, :fnmr, :pnmr, :bnmr, :nnmr, :mass1, :mass3, :buffer1, :buffer2, :buffer3, :oka, :okb, :singlepart_id, :description_id, :fulldoc_id)
    end
end
